                    ...
                    { 
                        ...
                        else 
                        {
                            if($("#ville").val().length < 5)
                            {
                                $('#myModal').modal("show");
                                $(".modal-title").text(" Veuillez remplir tout les champs !");
                                $('.modal-body').text(" le champs ville doit contenir au moins 5 caractères ");
                            }
                            else 
                            {
                                if($("#datedenaissance").val().length < 5)
                                ...
                                else
                                {
                                        ...
                                        else
                                        {
                                            ...
                                            && $("#ville").val() !== "" && $("#email").val() !== "" )
                                            {
                                                    ...
                                                    +document.querySelector("#ville").value+'&zoom=10&size=400x300&key=AIzaSyAkmvI9DazzG9p77IShsz_Di7-5Qn7zkcg"/></a>');
                                            }
